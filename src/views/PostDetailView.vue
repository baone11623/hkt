    ...
    <template v-else-if="post">
      ...
      <div class="container mx-auto px-4">
          ...
          <div class="bg-white p-6 sm:p-8 rounded-lg shadow-lg">
            ...
            <div class="flex items-center">
              ...
              <div class="ml-auto flex space-x-3">
                <button class="flex items-center text-gray-500 hover:text-primary-600 transition-colors">
        ...
        <div class="max-w-4xl mx-auto mt-8">
          ...
          <!-- Comments section -->
          <div class="mt-12">
            <h3 class="text-2xl font-bold mb-6">Comments ({{ post.commentsCount }})</h3>
            ...
            <div v-if="isAuthenticated" class="bg-gray-50 p-4 rounded-lg mb-8">
              ...
              <div class="mt-3 flex justify-end">
                ...
                >
                  <Loader2 v-if="isSubmittingComment" class="w-4 h-4 animate-spin mr-2" />
            ...
            <div v-else class="bg-gray-50 p-4 rounded-lg mb-8 text-center">
              <p class="text-gray-700 mb-3">You need to be logged in to comment.</p>
              <router-link to="/auth/login" class="btn btn-primary">Log In to Comment</router-link>
            </div>
            ...
            <div v-if="post.comments && post.comments.length > 0" class="space-y-6">
              ...
              >
                <div class="flex items-center mb-3">
                  <div class="w-8 h-8 rounded-full bg-primary-100 flex items-center justify-center text-primary-700 mr-2">
